...
import { ShareExternalLinks } from './ShareExternalLinks';
import { ShareUsageNotes } from './ShareUsageNotes';

interface ShareLogoInfoProps {
  logo: Logo;
}

export const ShareLogoInfo: React.FC<ShareLogoInfoProps> = ({ logo }) => {
